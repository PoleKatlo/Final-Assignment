    ...
    internal class Display : Decision_Menus                                                                                                           
    {
        ...
        public void processor()
        {
            ...
            if (option == 1)// option to calculate bill
            {
                ...
                File.AppendAllText("Bill Records.txt","Date                 :" + Date+ Environment.NewLine);
                File.AppendAllText("Bill Records.txt", "Names                :" + customer.Name + " " + customer.surname + Environment.NewLine);
                File.AppendAllText("Bill Records.txt", "Customer Location    :" + customer.Location + " " + customer.plotno + Environment.NewLine);
                File.AppendAllText("Bill Records.txt", "UserType             :" + customer.usertype + "" + "User" + Environment.NewLine);
                File.AppendAllText("Bill Records.txt", "Amount Of Water Used : " + customer.Water_Used + Environment.NewLine);
                File.AppendAllText("Bill Records.txt", "Total Cost           :BWP" + calculator.getbill(customer.Water_Used, customer.usertype) + Environment.NewLine);
                File.AppendAllText("Bill Records.txt", displayBill.starz()+Environment.NewLine);
